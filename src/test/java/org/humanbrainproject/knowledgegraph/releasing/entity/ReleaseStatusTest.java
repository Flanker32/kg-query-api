...
public class ReleaseStatusTest {
    ...
    public void isWorseThan() {
        ...
        Assertions.assertTrue(worseThan);
    }

    @Test
    public void isNotWorseThan() {
        boolean worseThan = ReleaseStatus.HAS_CHANGED.isWorseThan(ReleaseStatus.NOT_RELEASED);
        Assertions.assertFalse(worseThan);
    }

    @Test
    public void isWorst() {
        Assertions.assertTrue(ReleaseStatus.NOT_RELEASED.isWorst());
    }

    @Test
    public void isNotWorst() {
        Assertions.assertFalse(ReleaseStatus.HAS_CHANGED.isWorst());
        Assertions.assertFalse(ReleaseStatus.RELEASED.isWorst());
    }
}