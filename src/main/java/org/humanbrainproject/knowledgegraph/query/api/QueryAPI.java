...
public class QueryAPI {
    ...
    public ResponseEntity<QueryResult> applyFreemarkerTemplateToMetaApi(@PathVariable(ORG) String org, @PathVariable(DOMAIN) String domain, @PathVariable(SCHEMA) String schema, @PathVariable(VERSION) String version, @PathVariable(QUERY_ID) String queryId, @PathVariable(TEMPLATE_ID) String templateId, @PathVariable(LIBRARY) String library, @Parameter(description = "Defines if the underlying json (the one the template is applied to) shall be part of the result as well.") @RequestParam(required = false) boolean includeOriginalJson, @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorizationToken) throws Exception {
        try {
            authorizationContext.populateAuthorizationContext(authorizationToken);
    ...
    public ResponseEntity<QueryResult> queryPropertyGraphBySpecification(@RequestBody String payload, @PathVariable(ORG) String org, @PathVariable(DOMAIN) String domain, @PathVariable(SCHEMA) String schema, @PathVariable(VERSION) String version, @Parameter(description = VOCAB_DOC) @RequestParam(value = VOCAB, required = false) String vocab, @Parameter(description = SIZE_DOC) @RequestParam(value = SIZE, required = false) Integer size, @Parameter(description = START_DOC) @RequestParam(value = START, required = false) Integer start, @Parameter(description = RESTRICTED_ORGANIZATION_DOC) @RequestParam(value = ORGS, required = false) String organizations, @RequestParam(value = DATABASE_SCOPE, required = false) ExposedDatabaseScope databaseScope, @Parameter(description = SEARCH_DOC) @RequestParam(value = SEARCH, required = false) String searchTerm, @Parameter(description = ParameterConstants.AUTHORIZATION_DOC) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorizationToken, @Parameter(hidden = true) @RequestParam Map<String, String> allRequestParams) throws Exception {
        try {
            //Thread.sleep(2000);
            authorizationContext.populateAuthorizationContext(authorizationToken);
            queryContext.populateQueryContext(databaseScope);
    ...
    public ResponseEntity<Map> queryPropertyGraphBySpecificationWithId(@PathVariable(ORG) String org, @PathVariable(DOMAIN) String domain, @PathVariable(SCHEMA) String schema, @PathVariable(VERSION) String version, @PathVariable(INSTANCE_ID) String instanceId, @RequestBody String payload, @Parameter(description = VOCAB_DOC) @RequestParam(value = VOCAB, required = false) String vocab, @Parameter(description = RESTRICTED_ORGANIZATION_DOC) @RequestParam(value = RESTRICT_TO_ORGANIZATIONS, required = false) String restrictToOrganizations, @RequestParam(value = DATABASE_SCOPE, required = false) ExposedDatabaseScope databaseScope, @Parameter(description = ParameterConstants.AUTHORIZATION_DOC) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorizationToken, @Parameter(hidden = true) @RequestParam Map<String, String> allRequestParams) throws Exception {
        try {
            //Thread.sleep(2000);
            authorizationContext.populateAuthorizationContext(authorizationToken);
            queryContext.populateQueryContext(databaseScope);
    ...
    public ResponseEntity<QueryResult> executeStoredQuery(@PathVariable(ORG) String org, @PathVariable(DOMAIN) String domain, @PathVariable(SCHEMA) String schema, @PathVariable(VERSION) String version, @PathVariable(QUERY_ID) String queryId, @Parameter(description = SIZE_DOC) @RequestParam(value = SIZE, required = false) Integer size, @Parameter(description = START_DOC) @RequestParam(value = START, required = false) Integer start, @RequestParam(value = DATABASE_SCOPE, required = false) ExposedDatabaseScope databaseScope, @Parameter(description = SEARCH_DOC) @RequestParam(value = SEARCH, required = false) String searchTerm, @Parameter(description = VOCAB_DOC) @RequestParam(value = VOCAB, required = false) String vocab, @Parameter(description = RESTRICTED_ORGANIZATION_DOC) @RequestParam(value = RESTRICT_TO_ORGANIZATIONS, required = false) String restrictToOrganizations, @Parameter(description = ParameterConstants.AUTHORIZATION_DOC) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorizationToken, @Parameter(hidden = true) @RequestParam Map<String, String> allRequestParams) throws Exception {
        try {
    ...
    public ResponseEntity<Map> executeStoredQueryForInstance(@PathVariable(ORG) String org, @PathVariable(DOMAIN) String domain, @PathVariable(SCHEMA) String schema, @PathVariable(VERSION) String version, @PathVariable(QUERY_ID) String queryId, @PathVariable(INSTANCE_ID) String instanceId, @Parameter(description = RESTRICTED_ORGANIZATION_DOC) @RequestParam(value = RESTRICT_TO_ORGANIZATIONS, required = false) String restrictToOrganizations, @RequestParam(value = DATABASE_SCOPE, required = false) ExposedDatabaseScope databaseScope, @Parameter(description = VOCAB_DOC) @RequestParam(value = VOCAB, required = false) String vocab, @Parameter(description = AUTHORIZATION_DOC) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorizationToken, @Parameter(hidden = true) @RequestParam Map<String, String> allRequestParams) throws Exception {
        try {
            authorizationContext.populateAuthorizationContext(authorizationToken);
            queryContext.populateQueryContext(databaseScope);
            NexusSchemaReference schemaRef = new NexusSchemaReference(org, domain, schema, version);
